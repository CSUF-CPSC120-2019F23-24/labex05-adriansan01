...
int main()
{
  ...
  std::cout << "\nThe values of both are drifting away from 0 because their value is closer to 0 than the previous" << std::endl;
  std::cout << sizeof(d2) << " bytes, value: " << d2 << std::endl;
  std::cout << sizeof(f2) << " bytes, value: " << f2 << std::endl;
  ...
  std::cout << "\nSince the double is twice as detailed we get a more exact number" << std::endl;
  std::cout << sizeof(d2) << " bytes, value: " << d2 << std::endl;
  std::cout << sizeof(f2) << " bytes, value: " << f2 << std::endl;
  ...
  std::cout << "\nWe get an inf because float cannot put in as many numbers as double can" << std::endl;
